...
<header style="background-color: transparent;height: auto">
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
        <a class="navbar-brand" href="#">
            <img src="./imagines/logo1250x1250.png" width="50" height="50" class="d-inline-block align-top" alt=""/>
            Quizzicle
        </a>
        ...
        <div class="navbar-collapse -ml-24 flex w-full justify-around" id="navbarNav">
            <ul class="navbar-nav flex flex-col justify-center">

                <li class="nav-item active mr-5 flex items-center">
                ...
                <li class="nav-item mr-5 mt-1 flex items-center">
                ...
                <li class="nav-item mr-3 mt-1 flex items-center" id="custom-dropdown-li">
                    <button class="btn btn-primary dropdown-toggle bg-blue-500" type="button" id="dropdownMenuButton"
                    ...
                    <div class="dropdown" id="custom-dropdown">
                        <div class="dropdown-menu custom-dropdown" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item custom-dropdown-item" href="./user/set/create"><i
                                    class="fas fa-cog"></i>
                                Set</a>
                ...
                <c:if test="${sessionScope.user != null}">
                    <div class="navbar-nav flex items-center" style="margin-left: 30px;">
                        <li class="nav-item dropdown">
                            <a href="" class="text-white text-md dropdown-toggle flex items-center h-9"
                               aria-haspopup="true"
                               id="navbarDropdownNotification" data-toggle="dropdown" aria-expanded="false">
                        ...
                        <li class="nav-item dropdown flex items-center">
                            <a class="nav-link dropdown-toggle mt-0 flex gap-0.5" href="#" id="navbarDropdown"
                               role="button"
                               data-toggle="dropdown"
                               aria-haspopup="true" aria-expanded="false">
                                <img class="relative top-1" src="${sessionScope.user.avatar}" alt="UserAvatar"
                                     style="width: 25px;height: 25px;border-radius: 50%">
                            </a>
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="${pageContext.request.contextPath}/user/profile"><i
                                        class="fas fas-solid fa-gear"></i> Brief</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item"
                                   href="${pageContext.request.contextPath}/user/profile/update"><i
        ...
        <%--                                    class="fas fa-cog"></i>--%>
        <%--                                Set</a>--%>
        <%--                            &lt;%&ndash;                            <a class="dropdown-item custom-dropdown-item" href="./user/set/create"><i class="fas fa-folder"></i>&ndash;%&gt;--%>
        <%--                            &lt;%&ndash;                                Question</a>&ndash;%&gt;--%>
        <%--                            <a class="dropdown-item custom-dropdown-item" href="./user/room"><i--%>
        <%--                                    class="fa-solid fa-people-group"></i>--%>
        <%--                                Room</a>--%>
        <%--                        </div>--%>
        ...
        <%--                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">--%>
        <%--                                <a class="dropdown-item" href="${pageContext.request.contextPath}/user/profile"><i--%>
        <%--                                        class=" sfa-solid fa-gear"></i> Brief</a>--%>
        <%--                                <div class="dropdown-divider"></div>--%>
        <%--                                <a class="dropdown-item"--%>
        <%--                                   href="${pageContext.request.contextPath}/user/profile/update"><i--%>
        <%--                                        class="fas fa-cogs"></i> Settings</a>--%>
