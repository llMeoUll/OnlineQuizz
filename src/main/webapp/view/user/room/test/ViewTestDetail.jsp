...
<div class="container" style="margin-top: 96px">
    <div class="card  mb-3">
        ...
        <div class="card-body d-flex justify-content-between align-items-center">
            ...
            <div class=" fs-5 ">
                <a class=" fs-3 text-decoration-none" href="${pageContext.request.contextPath}/user/room/get?roomId=${requestScope.currentTest.room.roomId}">Room: ${requestScope.currentTest.room.roomName}</a>
                <h3>Title: ${requestScope.currentTest.testName}</h3>
            ...
            <c:if test="${sessionScope.user.id eq requestScope.currentTest.room.user.id}">
                <!-- Settings Dropdown -->
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item"
                               href="${pageContext.request.contextPath}/user/room/test/update?testId=${requestScope.currentTest.testId}">Edit</a>
                        </li>
                        <li><a class="dropdown-item" href="#" onclick="showDeleteConfirmation()">Delete</a></li>
                    </ul>
                </div>
                <!-- Edit Room Modal -->
                <div class="modal" id="editTestModal" tabindex="-1" aria-labelledby="editTestModalLabel"
                     aria-hidden="true">
        ...
        <div class="card-footer">
            <c:if test="${requestScope.currentTest.room.user.id ne sessionScope.user.id}">
                <a href="${pageContext.request.contextPath}/user/room/test/dotest?testId=${requestScope.currentTest.testId}" class="btn btn-primary">Do Test</a>
            </c:if>
            <a href="${pageContext.request.contextPath}/user/room/test/leaderboard?testId=${requestScope.currentTest.testId}" class="btn btn-primary">Leader board</a>
        </div>
    </div>
</div>
