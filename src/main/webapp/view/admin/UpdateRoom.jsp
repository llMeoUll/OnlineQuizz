                        ...
                        <form action="./update" method="post" class="mx-1 mx-md-4">
                            ...
                            <div class="d-flex flex-row align-items-center mb-4">
                                ...
                                <div class="form-outline flex-fill mb-0">
                                    <input type="text" name="roomName" placeholder="Room Name" class="form-control" value="${requestScope.room.roomName}"
                                           required/>
                                </div>
                            </div>
                            <div class="d-flex flex-row align-items-center mb-4">
                                ...
                                <div class="form-outline flex-fill mb-0">
                                    <input type="text" name="description" placeholder="Description" class="form-control" value="${requestScope.room.description}"
                                           required/>
                                </div>
                            </div>
