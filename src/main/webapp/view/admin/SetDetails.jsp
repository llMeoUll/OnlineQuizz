              ...
              <div class="row">
                ...
                <div class="col-md-4 mt-3">
                  ...
                  <ul class="list-unstyled">
                    <li>Owner: <a href="/Quizzicle/admin/user/profile?uid=${requestScope.set.getUser().id}">
                      ${requestScope.set.getUser().familyName}
                      ${requestScope.set.getUser().givenName}</a></li>
                    <li>Email: ${requestScope.set.getUser().email}</li>
                    <li>${requestScope.set.isPrivate() ? "Private" : "Public"}</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div class="card mb-4 mt-2">
            ...
            <div class="card-body">
              <table id="datatablesSimple">
                ...
                <tbody>
                <c:forEach items="${requestScope.set.getQuestions()}" var="question">
                  <tr>
